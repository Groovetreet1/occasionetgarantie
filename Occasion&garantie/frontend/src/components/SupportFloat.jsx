...
import { FiArrowUp, FiHeadphones, FiX, FiSend, FiCheckCircle, FiMail, FiAlertCircle, FiEdit3, FiInfo } from 'react-icons/fi';
...
const choices = [
  ...
  { value: 'changement_nom_store', label: 'Changement de nom de store', icon: FiEdit3, color: '#3b82f6', desc: 'Demander la modification du nom de votre boutique.' },
          ...
          <div className="support-popup-body">
            ...
            {step === 'form' && (
              <form onSubmit={handleSubmit}>
                ...
                <div className="form-group">
                  <textarea rows={4}
                    placeholder={selectedType === 'changement_nom_store' ? 'Nouveau nom de store souhaite et raison du changement...' : 'Decrivez votre demande...'}
