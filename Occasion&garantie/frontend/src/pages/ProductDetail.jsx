...
import { FiArrowLeft, FiShoppingBag, FiShield, FiCheck, FiMonitor, FiCpu, FiHardDrive, FiBattery, FiCamera, FiDroplet } from 'react-icons/fi';
    ...
    <section style={{ paddingTop: '100px', paddingBottom: '60px' }}>
      <div className="container">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '48px', alignItems: 'start' }}>
          <div className="product-image" style={{ aspectRatio: '1', borderRadius: 'var(--radius-lg)', position: 'sticky', top: '100px', overflow: 'hidden' }}>
            {imgUrl ? (
