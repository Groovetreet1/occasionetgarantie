...
<h1 style="font-size:20px;font-weight:700;color:#1e293b;margin:16px 0 4px">Vérification de compte</h1>
...
<div style="background:rgba(245,158,11,0.10);border-radius:12px;padding:24px;margin-bottom:24px;border:1px solid #f59e0b">
<span style="font-size:40px;font-weight:800;color:#f59e0b;letter-spacing:8px;font-family:monospace">${code}</span>
</div>
